...
def gen_model(args):
    ...
    if args.backbone == "rev":
        model = RevGAT(
                      ...
                      dcn_scale=args.dcn_scale,
                      dcn_use_mean=args.dcn_use_mean,
                      dcn_use_norm=args.dcn_use_norm,
                      dcn_use_scale=args.dcn_use_scale,
                      tau=args.tau)
    else:
...
def main():
    ...
    argparser.add_argument('--dcn_scale', type=float, default=1.0)
    argparser.add_argument('--dcn_use_mean', action='store_true')
    argparser.add_argument('--dcn_use_norm', action='store_true')
    argparser.add_argument('--dcn_use_scale', action='store_true')
    argparser.add_argument('--tau', default=1.0, type=float)
