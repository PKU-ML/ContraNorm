...
class DCN(nn.Module):
    def __init__(self, scale, use_mean, use_norm, use_scale, tau=1.0):
...
class RevGAT(nn.Module):
    def __init__(
        ...
        self.dcn = DCN(dcn_scale, use_mean=dcn_use_mean, use_norm=dcn_use_norm, use_scale=dcn_use_scale, tau=tau)
