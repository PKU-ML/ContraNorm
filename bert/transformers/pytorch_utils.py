...
def apply_chunking_to_forward(
    forward_fn: Callable[..., torch.Tensor], cal_svd: bool, cal_metrics: bool, chunk_size: int, chunk_dim: int, *input_tensors
) -> torch.Tensor:
    """
    ...
    num_args_in_forward_chunk_fn = len(inspect.signature(forward_fn).parameters) - 2
    ...
    return forward_fn(*input_tensors, cal_svd, cal_metrics)
